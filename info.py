...
SHORTENER_API2 = environ.get("SHORTENER_API2", "False")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'False')
SHORTENER_API3 = environ.get("SHORTENER_API3", "False")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", 'False')
TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "False"))
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "False"))
#---------------------------------------------------------------
#---------------------------------------------------------------
